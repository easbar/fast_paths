...
mod tests {
    ...
    fn run_performance_test_dist_nyc() {
        ...
        run_performance_test(
            &InputGraph::from_dimacs_file("USA-road-d.NY.gr"),
            &Params::default(),
            50030355437,
            0,
        )
    ...
    fn run_performance_test_time_nyc() {
        ...
        run_performance_test(
            &InputGraph::from_dimacs_file("USA-road-t.NY.gr"),
            &Params::default(),
            67055135006,
            0,
        );
    ...
    fn run_performance_test_dist_cali() {
        ...
        run_performance_test(
            &InputGraph::from_dimacs_file("USA-road-d.CAL.gr"),
            &Params::default(),
            501405803172,
            0,
        )
    ...
    fn run_performance_test_time_cali() {
        ...
        run_performance_test(
            &InputGraph::from_dimacs_file("USA-road-t.CAL.gr"),
            &Params::default(),
            626039623642,
            0,
        );
    ...
    fn run_performance_test_dist_usa() {
        ...
        run_performance_test(
            &InputGraph::from_dimacs_file("USA-road-d.USA.gr"),
            &Params::default(),
            1857875271230,
            0,
        )
    ...
    fn run_performance_test_time_usa() {
        ...
        run_performance_test(
            &InputGraph::from_dimacs_file("USA-road-t.USA.gr"),
            &Params::default(),
            2081172750426,
            0,
        );
